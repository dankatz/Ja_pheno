...
### NEXT STEPS: extract site means for each site: core and snap
### compare cones vs pollen sacs data at site level
### implement cone model for previous year!!

#simulation for each snap site
